...
@Module({
  ...
  providers: [ClienteService, FornecedorService, EnderecoService,PedidoService],
  controllers: [ClienteController, EnderecoController, FornecedorController, PedidoController],
})
